...
<body>
    <div class="container">
            ...
            <% if (billItems != null && !billItems.isEmpty()) { %>
                <table>
                    ...
                    <% for (BillItem billItem : billItems) { %>
                        <% Item item = null;
                           try {
                               item = staffService.getItemById(billItem.getItemId());
                           } catch (SQLException e) {
                               e.printStackTrace();
                           }
                        %>
        ...
        %>
        <button class="back-btn" onclick="window.location.href='${pageContext.request.contextPath}/ViewBillsControl'">Back to All Bills</button>
    </div>
</body>
</html>