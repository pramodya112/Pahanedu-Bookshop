...
<head>
    ...
    <meta name="description" content="Pahanedu Bookshop Edit Item">
...
<body>
    ...
    <div class="main-content">
        <div class="header-banner">
            ...
            <p class="welcome-text">Update item details for Pahanedu Bookshop.</p>
        </div>
            ...
            <% } else { %>
                <div class="form-container">
                    ...
                    <% if (error != null) { %>
                        ...
                        <a href="${pageContext.request.contextPath}/manageItems" class="back-btn">Back to Manage Items</a>
                    <% } %>
                    ...
                    <% if (item != null) { %>
                        <form action="${pageContext.request.contextPath}/manageItems" method="post">
                            ...
                            <select name="genre" id="genre" required>
                                <option value="Fiction" <%= "Fiction".equals(item.getGenre()) ? "selected" : "" %>>Fiction</option>
                                <option value="Non-Fiction" <%= "Non-Fiction".equals(item.getGenre()) ? "selected" : "" %>>Non-Fiction</option>
                                <option value="Science Fiction" <%= "Science Fiction".equals(item.getGenre()) ? "selected" : "" %>>Science Fiction</option>
                                <option value="Fantasy" <%= "Fantasy".equals(item.getGenre()) ? "selected" : "" %>>Fantasy</option>
                                <option value="Mystery" <%= "Mystery".equals(item.getGenre()) ? "selected" : "" %>>Mystery</option>
                                <option value="Biography" <%= "Biography".equals(item.getGenre()) ? "selected" : "" %>>Biography</option>
                                <option value="Romance" <%= "Romance".equals(item.getGenre()) ? "selected" : "" %>>Romance</option>
                                <option value="History" <%= "History".equals(item.getGenre()) ? "selected" : "" %>>History</option>
                            </select>
