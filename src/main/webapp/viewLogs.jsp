...
<%@ page import="java.util.List, com.example.model.Log, com.example.model.Staff" %>
<%
...
<head>
    ...
    <meta name="description" content="Pahanedu Bookshop View Logs">
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav flex-column">
            ...
            <% if (currentStaff != null && "admin".equals(currentStaff.getRole())) { %>
                ...
                <a href="${pageContext.request.contextPath}/viewLogs" class="nav-link active"><span class="nav-icon">📜</span>View Logs</a>
            <% } else { %>
    ...
    <div class="main-content">
        <div class="header-banner">
            <h2 class="main-title">View Logs</h2>
            <p class="welcome-text">Review system activity logs for Pahanedu Bookshop.</p>
        </div>
