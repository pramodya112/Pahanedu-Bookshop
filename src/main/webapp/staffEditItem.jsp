...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav flex-column">
            ...
            <% } else { %>
                <a href="${pageContext.request.contextPath}/staffManageItems" class="nav-link active"><span class="nav-icon">📚</span>Manage Items</a>
            ...
            <% } else { %>
                <div class="form-container">
                    ...
                    <% if (error != null) { %>
                        ...
                        <a href="${pageContext.request.contextPath}/staffManageItems" class="back-btn">Back to Manage Items</a>
                    <% } %>
