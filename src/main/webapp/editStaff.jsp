...
<head>
    ...
    <meta name="description" content="Pahanedu Bookshop Edit Staff">
    <title>Pahanedu Bookshop - Edit Staff</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header-banner">
            <h2 class="main-title">Edit Staff</h2>
            <p class="welcome-text">Update staff details for Pahanedu Bookshop.</p>
        </div>
                ...
                <div class="form-container">
                    ...
                    <% if (staff != null) { %>
                        <form action="${pageContext.request.contextPath}/manageStaff" method="post">
                            ...
                            <input type="text" name="gmail" id="gmail" value="<%= staff.getGmail() %>" required>
                            <label for="role">Role</label>
                            <select name="role" id="role" required>
                                <option value="admin" <%= "admin".equals(staff.getRole()) ? "selected" : "" %>>Admin</option>
                                <option value="staff" <%= "staff".equals(staff.getRole()) ? "selected" : "" %>>Staff</option>
                            </select>
