...
<head>
    ...
    <meta name="description" content="Pahanedu Bookshop Admin Dashboard">
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav flex-column">
            ...
            %>
            <a href="<%= dashboardUrl %>" class="nav-link <%= request.getRequestURI().contains("adminDashboard") ? "active" : "" %>"><span class="nav-icon">🏠</span><%= dashboardLabel %></a>
    ...
    <div class="main-content">
        <div class="header-banner">
            ...
            <p class="welcome-text">Welcome, <%= currentStaff != null ? currentStaff.getFirstName() + " " + currentStaff.getLastName() : "Admin" %>! Manage your bookshop operations.</p>
        </div>
        ...
        <div class="container">
            ...
            %>
                ...
                <a href="${pageContext.request.contextPath}/login.jsp" class="back-btn">Login</a>
            <% } else { %>
                <div class="dashboard-tiles">
                    ...
                    <div class="tile" onclick="window.location.href='${pageContext.request.contextPath}/manageStaff'">
                        <span class="tile-icon">👥</span>
                        <h3 class="tile-title">Manage Staff</h3>
                        <p class="tile-description"></p>
                    </div>
                    <div class="tile" onclick="window.location.href='${pageContext.request.contextPath}/manageItems'">
                        <span class="tile-icon">📚</span>
                        <h3 class="tile-title">Manage Items</h3>
                        <p class="tile-description"></p>
                    </div>
                    <div class="tile" onclick="window.location.href='${pageContext.request.contextPath}/viewLogs'">
                        <span class="tile-icon">📜</span>
                        <h3 class="tile-title">View Logs</h3>
                        <p class="tile-description"></p>
                    </div>
